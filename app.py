...
# Ключ Gemini API
GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY", "AQ.Ab8RN6IrLfesX8R8ePt9lnZ8RiOnlKb6vZg8Y5Jknnin74Aijw")
...
# ==============================================================================
# 🧠 БЕСПЛАТНЫЙ GEMINI AI (ОБЩЕНИЕ И ОЦЕНКА ВНЕШНОСТИ)
# ==============================================================================
...
async def btn_admin_panel(message: Message):
    ...
    admin_text = (
        ...
        "Выберите раздел для просмотра выгрузки фотографий или истории переписок с ИИ:"
    )
...
async def handle_ai_chat_message(message: Message):
    ...
    sys_prompt = "Ты — ИИ-агент по оценке внешности и луксмаксингу. Отвечай прямо, коротко и по делу."
...
# Запуск бота в фоновом потоке с защитой от многократного запуска
